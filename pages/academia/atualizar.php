        ...
        <div id="center">
            <form action=' ' method="post" class="meio">
                <label>
                    ...
                    <button class="test button" type="submit">Enviar</button>
                </label>
            </form>
            <?php
                $idd = $_SESSION['id'];
                ...
                while($acumula = mysqli_fetch_array($query)) {
                    ...
                    ?>
            <?php echo "
    <form id='form_main' method='post' action='../../php/academia/updateacademia.php'>
           <p class='text'>Entrada</p>
                <input value='".$id."' type='hidden' name='id_academia' >
            ...
            <form action='../../php/academia/deleteacademia.php' method='post'>
                <input value='".$id."' type='hidden' name='id_academia'>
